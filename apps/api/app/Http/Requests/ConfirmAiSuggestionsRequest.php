...
class ConfirmAiSuggestionsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tasks.*.resources' => ['sometimes', 'array', 'max:5'],
            ...
            'tasks.*.subtasks.*.resources' => ['sometimes', 'array', 'max:5'],
            'tasks.*.subtasks.*.resources.*.title' => ['required', 'string', 'max:120'],
            'tasks.*.subtasks.*.resources.*.url' => ['required', 'url:http,https', 'max:1000'],
